const references = [
  ...
  },
  {
    ...
    venue: "arXiv preprint",
    finding: "radiologist gaze에서 report sentence별 후보 영역을 만들고, class 기반 detection과 text 기반 phrase grounding을 비교해 phrase grounding의 위치 성능 우위를 보고했다.",
    why: "GazeMed PR #3과 가장 가까운 task 경계다. text-conditioned localization만으로는 새롭지 않으며, test-time gaze+speech와 각 정보 제거 대조의 추가 가치를 분리해야 한다.",
  ...
  },
  {
    ...
    venue: "NeurIPS",
    finding: "CXR image와 text phrase의 similarity-based cross-attention으로 별도 task-specific training 없이 분류·국소화·분할을 다루는 zero-shot 모델이다.",
    why: "GazeMed PR #3의 외부 image+phrase 기준선이다. 입력 modality가 다르므로 우열보다 오류 상보성과 fusion ceiling을 분석하는 데 중요하다.",
